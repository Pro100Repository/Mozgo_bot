...
async def cmd_admin_help(message: Message):
    ...
    await message.answer(
        ...
        "🏆 *Результаты игр (новая система):*\n"
        "`/add_result_new` — добавить результат (пошаговая форма)\n"
        "`/list_results` — список результатов\n"
        "`/edit_result ID` — редактировать результат\n"
        ...
        "`/quiz_stats` — сколько вопросов в каждой категории",
        parse_mode="Markdown"
    )
