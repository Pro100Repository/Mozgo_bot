...
async def cmd_admin_help(message: Message):
    ...
    await message.answer(
        ...
        "📅 *Игры:*\n"
        "`/add_game Название | Дата | Время | Город | Место | Ссылка на регистрацию`\n\n"
        "` ПРИМЕР(Все значения надо прописывать через вертикальную черту) /add_game Классическая | 01.01.2027 | 22:00 | Мозгожопинск | В клубе | Ссылка `\n\n"
        "`/list_games` — список игр с ID\n"
        "`/del_game ID` — удалить игру где ID это номер игры который в списке\n"
        "`/add_photo ID` - 📷 прикрепить фото к игре\n\n"
        "🏆 *Результаты игр:*\n"
