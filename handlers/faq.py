    ...
    "registration": {
        ...
        "sub": {
            "how_to_register": {
                ...
                "answer": (
                    'Способ регистрации существует только один - на сайте <a href="https://rudagames.com">rudagames.com</a> 💜\n\n'
                    "ТУТ ТЕКСТ\n\n"
                    'Возникли проблемы при регистрации? Напиши нашему <a href="https://t.me/organizer_username">Администратору</a> '
                    'или в поддержку на сайте <a href="https://rudagames.com">rudagames.com</a>'
                )
            },
            "registration_deadline": {
                ...
                "answer": (
                    ...
                    'Остались вопросы по регистрации? Напиши нашему <a href="https://t.me/organizer_username">Администратору</a> \n\n'
            ...
            "cancel_registration": {
                ...
                "answer": (
                    "❌ Отмена регистрации:\n\n"
                    'Если у вас возникли непредвиденные обстоятельства, отменить регистрацию можно в личном кабинете на сайте <a href="https://rudagames.com">rudagames.com</a> 😔\n\n'
        ...
        "sub": {
            "where": {
                ...
                "answer": (
                    ...
                    "Проверяй раздел «Предстоящие игры» для актуальных адресов и 👇 подписывайся на рассылку 👇 о предстоящих играх в твоем городе! 🙃"
                )
            },
            "when": {
