        ...
        "sub": {
            "how_to_register": {
                ...
                "answer": (
                    ...
                    "Краткая инструкция, как зарегистрироваться на игру:\n\n"
                    "1️⃣ Зайди на rudagames.com и выбери свой город;\n"
                    "2️⃣ Выбери игру из доступных в расписании;\n"
                    "3️⃣ Нажми «Зарегистрироваться» и заполни данные для участия;\n"
                    "4️⃣ Подтверди адрес электронной почты - после этого регистрация будет завершена.\n\n"
                    "После первой регистрации автоматически создаётся личный кабинет.\n" 
                    "В следующий раз данные уже не придётся вводить заново - зарегистрироваться на игру будет проще и быстрее.\n"
                    "Выбирай город, игру и не забудь сообщить своей команде, куда и во сколько приходить 😉\n\n"
