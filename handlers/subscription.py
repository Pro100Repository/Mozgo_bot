...
NOTIFY_PREFS = [
    ...
    ("reg14d", "📝 За 2 недели, после открытия регистрации"),
]

NOTIFY_PREFS_TEXT = (
    "⏰ *Когда присылать напоминания об играх?*\n\n"
    "Можно выбрать сразу несколько вариантов — нажимай на нужные 👇\n\n"
    "ℹ️ *Про вариант «За 2 недели, после открытия регистрации»:* игры добавляются "
    "в бота примерно раз в месяц, поэтому по самым первым играм после "
    "включения этой функции такое напоминание может не прийти. Для игр, "
